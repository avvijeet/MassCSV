...
def read_and_save_csv_in_chunks(bucket_name: str, s3_key: str) -> Iterator[str]:
...
def main():
    ...
    try:
        ...
        read_and_save_csv_in_chunks(bucket_name=bucket_name, s3_key=s3_key)
        logger.success("CSV processing completed successfully.")
    except Exception as e:
        logger.error(
            f"An error occurred: {e}. Checkpoint saved. You can re-run the script to continue.")
